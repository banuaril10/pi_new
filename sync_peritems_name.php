	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<h4>SYNC SKU ITEMS BY NAME <?php //echo $_SESSION['org_key']; ?></h4>	
				<p style="color: red; font-weight: bold">Note : scan/ketik nama items yg berubah sku nya</p>
			</div>
			<div class="card-body">
			<div class="tables">
				...
				<div class="table-responsive bs-example widget-shadow">				
					...
					<input style="margin-bottom: 10px" type="text" id="sku" class="form-control" id="exampleInputName2" placeholder="Nama Items" autofocus>
...
input.addEventListener("keypress", function(event) {
  if (event.key === "Enter") {
	...
	$.ajax({
		url: "api/action.php?modul=inventory&act=sync_pos_peritems_name",
		type: "POST",
		data : {sku: sku},
		beforeSend: function(){
